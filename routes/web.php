<?php
	...
	Route::get('prescreen','HomeController@create');
...
// Password Reset Routes...
	...
	$this->post('password/reset', 'Auth\ResetPasswordController@reset')->name('auth.password.reset');Route::resource('users', 'Admin\UsersController');
